...
rm -f Gemfile
rm -f Gemfile.lock
cp gemfiles/base+nostdlib Gemfile

gem cleanup
bundle i
bundle exec rbwasm build --dest-dir ./vfs --build-profile minimal -o dist/assets/wasm/ruby.wasm
...
mv dist ../../server/web/patch+nostdlib
